...
const config = {
    info: {
        ...
        authors: [
            {
                name: "m.",
                discord_id: "759933413968314369",
                github_username: "Mosie0",
                twitter_username: "m6sie"
            }
        ],
        version: "0.0.2",
                            ...
                            children: [
                                {
                                    ...
                                    action: () => {
                                        ...
                                        Toasts.success(`Copied \`${user.username}\`#\`${user.discriminator}\`'s user ID.`);
                                    }
                                },
                                {
                                    label: "Name",
                                    ...
                                    action: () => {
                                        ...
                                        Toasts.success(`Copied username: \"\`${user.username}\`\"`);
                                    }
                                },
                                {
                                    label: "Avatar Url",
